...
try:
    ...
    try:
        ...
        today_icon_y = today_block_y + ((block_height - today_card_label_height - icon_size[0] - padding * 2) / 2)
        tomorrow_icon_y = tomorrow_block_y + ((block_height - tomorrow_card_label_height - icon_size[0] - padding * 2) / 2)
